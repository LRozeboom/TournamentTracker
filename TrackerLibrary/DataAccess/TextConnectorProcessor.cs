...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // id,teamname,list of id's seperated by the pipe
            // 3,Tim's team,1|3|5
        ...
        {
            //id,TournamentName,EntryFee,(id|id|id... - EnteredTeams),(id|id|id... - Prizes),(id^id^id|id^id^id|... - Rounds)
        ...
        public static void SaveRoundsToFile(this TournamentModel model, string matchupFile, string matchupEntryFile)
        {
            ...
            // Save the matchup and get the ID for the new matchup and save the record
